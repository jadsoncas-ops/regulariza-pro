  ...
  try {
    ...
    const processo = await prisma.processo.create({
      data: {
        ...
        tarefas: {
          create: tarefasAutomaticas
        },
        logs: {
          create: [
            { acao: 'Abertura de Processo Operacional', usuario: 'SISTEMA', modulo: 'Workflow' },
            { acao: 'Geração Automática de Workflow Executivo', usuario: 'SISTEMA', modulo: 'Workflow' }
          ]
        }
      },
      include: {
